...
#
dicomParentDir=/data/birc/Atlanta/OMT/06.acqfiles/OMT997/pilot1/from.dcm2nii.via.Stephen
...
fmriSeriesList="foot.runorder01 foot.runorder02 foot.runorder03 foot.runorder04"
...
echo "  1) counting the number of Niftis"
...
for seriesNumber in ${fmriSeriesList}; do
      ...
      echo ""
      analyze2bxh ${dicomParentDir}/${seriesNumber}/* ${tempDir}/fmriSeries.${seriesNumber}.bxh
      echo ""
      echo "...done."
      echo ""
