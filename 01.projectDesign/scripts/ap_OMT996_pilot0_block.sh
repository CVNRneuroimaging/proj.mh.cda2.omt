...
acqfiles="/data/birc/Atlanta/OMT/06.acqfiles/OMT996/pilot0/FmriFootTapping/*_MNI.nii"
# ...anatomic T1 (not skull-stripped) to be used as an afni_proc input:
anatWithSkull="/data/birc/Atlanta/OMT/06.acqfiles/OMT996/pilot0/Anatomic/OMT996_pilot0_Anatomic_MNI.nii.gz"
# ...number of warm-up TRs that were collected at the start of each run:
disdacqs=2
# ...stimulus timing files detailing task timing:
stimTimesIG="/data/birc/Atlanta/OMT/03.FmriRegressors/OMT996/pilot0/IG_OMT996_pilot0_stim_timing_4_runs_1_1_2_3_no_voice_cues_assume_zero_begin.txt"
stimTimesEG="/data/birc/Atlanta/OMT/03.FmriRegressors/OMT996/pilot0/EG_OMT996_pilot0_stim_timing_4_runs_1_1_2_3_no_voice_cues_assume_zero_begin.txt"
# ...participant identifier to be used in output filenames:
participant="pOMT996s00.onsetsBlock.basisTent12.includesContrast"
